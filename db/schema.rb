...
ActiveRecord::Schema.define(version: 2019_10_24_123039) do
  ...
  create_table "jointables", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_jointables_on_doctor_id"
    t.index ["speciality_id"], name: "index_jointables_on_speciality_id"
  end
